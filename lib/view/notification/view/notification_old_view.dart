...
class NotificationOldView extends StatelessWidget {
  final NotificationViewOldController controller = Get.put(NotificationViewOldController());

  NotificationOldView({super.key});
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              const Width(width: 5),
                              const CustomText("Notification", fontSize: 24, fontWeight: FontWeight.w500),
                            ],
                          ),
                          const SizedBox(),
                        ],
