...
class CommonDropdown extends StatelessWidget {
  ...
  const CommonDropdown({
    ...
    this.hintStyle,
    this.itemTextStyle,
    this.dropdownIcon = const Icon(Icons.keyboard_arrow_down_outlined, size: 16),
    this.buttonPadding,
    ...
    return Column(
      ...
      children: [
        ...
        DropdownButton2<String>(
          ...
          value: selectedValue,
          hint: CustomText(hintText, color: AppColors.inActive),
          ...
          buttonStyleData: ButtonStyleData(
            padding: buttonPadding ?? const EdgeInsets.symmetric(horizontal: 8, vertical: 5),
